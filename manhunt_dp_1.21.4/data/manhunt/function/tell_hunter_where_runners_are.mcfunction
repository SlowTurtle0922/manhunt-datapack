...
execute as @a[team=runner] run tellraw @a[tag=who_wants_runner_pos] {"selector":"@s","color":"green","extra":[{"text":" [","color":"white","extra":[{"score":{"name":"@s","objective":"runner_x"},"color":"red"}," ",{"score":{"name":"@s","objective":"runner_y"},"color":"red"}," ",{"score":{"name":"@s","objective":"runner_z"},"color":"red"}," ",{"nbt":"Dimension","entity":"@s","color":"yellow"},"]"]}]}
