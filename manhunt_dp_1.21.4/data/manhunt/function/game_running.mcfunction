...
execute as @a[team=hunter] unless items entity @s container.* compass unless items entity @s weapon.offhand compass unless items entity @s player.crafting.* compass run give @s minecraft:compass 1
